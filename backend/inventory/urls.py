...
# Stock Inventory Routes
    ...
    path("add-new-item/", views.add_new_item_view, name="add_new_item_view"),
    ...
    path('mark-defect-as-returned-replaced/', views.mark_defect_as_returned_replaced_view, name='mark_defect_as_returned_replaced'),
    path('mark-defect-as-returned-refunded/', views.mark_defect_as_returned_refunded_view, name='mark_defect_as_returned_refunded'),
   ...
   # path("add/", views.add_stock_item_view, name="add_stock_item"),
    ...
    path("add-new-item3/", views.add_new_item_view3, name="add_new_item_view3"),
]