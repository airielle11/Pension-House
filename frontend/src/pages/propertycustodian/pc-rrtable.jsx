...
import ProductRequisitionTable from './pc-item-req-table';// Import Product Requisition Table
import JobRequisitionTable from './pc-job-req-table'; // Import Job Requisition Table
