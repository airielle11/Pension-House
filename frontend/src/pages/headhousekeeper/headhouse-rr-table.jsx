...
import ProductRequisitionTable from '../dashboard/ItemRequisitionTable'; // Import Product Requisition Table
import JobRequisitionTable from './hh-job-req-table'; // 
...
function RRTable({ setHideAnalytics }) {
    ...
    const requests = [
        ...
        { id: 3, roomNo: 103, roomType: 'Suite', floorNo: 5, requestedBy: 'MichaSel Johnson', date: '2024-12-04', status: 'Pending' },
    ];
