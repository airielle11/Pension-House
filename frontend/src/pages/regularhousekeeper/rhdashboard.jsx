...
import RRTable from './rh-rrtable'; // Importing the RRTable component
import ItemRequisitionTable from './rh-item-req-table'; // Import Product Requisition Table
...
export default function RegularHousekeepeer() {
