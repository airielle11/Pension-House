...
export default function Profile() {
  ...
  useEffect(() => {
    ...
    ? storedName.split(",").reverse().map((name) => name.trim()).join(" ")
    : storedName;
    ...
    <Box sx={{ flexShrink: 0, ml: 0.75 }}>
      ...
      >
        <Stack
          ...
          sx={{ p: 0.5 }}
        >
          <Avatar alt="User Profile Picture" src={avatar1} size="sm" />
                    ...
                    >
                      <Grid item>
                        ...
                        >
                          ...
                          />
                          <Stack>
                            <Typography variant="h6">{localStorage.getItem("name") || "User"}</Typography>
